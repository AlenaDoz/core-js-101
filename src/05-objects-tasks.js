...
class CssSelectorBuilder {
  constructor() {
    this.selectors = [];
    this.types = [];
    this.order = ['element', 'id', 'class', 'attribute', 'pseudo-class', 'pseudo-element'];
  }
  ...
  pseudoClass(value) {
    ...
    this.types.push('pseudo-class');
    return this;
  }

  pseudoElement(value) {
    this.selectors.push(`::${value}`);
    this.isUnique('pseudo-element');
    this.checkOrder('pseudo-element');
    this.types.push('pseudo-element');
    return this;
  }
